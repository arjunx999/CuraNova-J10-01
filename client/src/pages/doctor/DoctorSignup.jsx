...
const DoctorSignup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    formData.append("degrees", signupInfo.degrees);
    formData.append("hospital_name", signupInfo.hospital_name);
    formData.append("about", signupInfo.about);
    formData.append("consultation_fee", signupInfo.consultation_fee);
    formData.append("department", signupInfo.department);
    formData.append("image", file);

    try {
      const res = await axios.post("/auth/doctor/register", formData);
      setEmailSent(true);
    } catch (error) {
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 text-sm rounded-lg bg-[#f8f8f8] border border-[#e6e6e6] focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition"
                        value={signupInfo.hospital_name}
                        onChange={handleInputChange}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-3 py-2 text-sm rounded-lg bg-[#f8f8f8] border border-[#e6e6e6] focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition"
                        value={signupInfo.consultation_fee}
                        onChange={handleInputChange}
                      />
                    </div>
                  </div>
